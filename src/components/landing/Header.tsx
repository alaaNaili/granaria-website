          ...
          <nav className="flex flex-col gap-3">
            {navKeys.map((key) => (
              <a
                ...
                className={`text-sm font-medium text-muted-foreground hover:text-foreground transition-colors py-2 ${key === navKeys[0] ? "mt-3" : ""}`}
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="sm"
                  className="mt-2 gap-1.5 font-medium w-full justify-start"
                >
                  {i18n.language === "en" ? "EN" : "FR"}
